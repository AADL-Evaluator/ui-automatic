...
public class EditBusAndCpuActionListener implements ActionListener
{
    private final AutomaticBindingListJPanel panel;
    
    public EditBusAndCpuActionListener( AutomaticBindingListJPanel panel )
    {
        this.panel = panel;
    }
    ...
    private void open( DefaultMutableTreeTableNode node )
    {
        ...
        final BusAndCpuSelectedJDialog dialog = new BusAndCpuSelectedJDialog( 
